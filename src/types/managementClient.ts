 ...
 * The functions are generated in the client.
 *
 ...
 *
 * Note that most (all?) functions will return unauthorized unless that operation is specifically
 * permitted by the scope of the Oauth token returned, which requires requesting the scope
 * when requesting the token, and for that scope to be permitted in the Auth0 management console
 * located at {YOUR_DOMAIN}.auth0.com
 *
